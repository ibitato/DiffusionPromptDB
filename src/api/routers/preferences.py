...
async def update_preferences(
    ...
    if not current:
        ...
        my_prompts = preferences.my_prompts_only if preferences.my_prompts_only is not None else False
        ...
        my_prompts = preferences.my_prompts_only if preferences.my_prompts_only is not None else current_my_prompts
