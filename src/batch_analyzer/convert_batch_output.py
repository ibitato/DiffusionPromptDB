...
def main():
    ...
    parser = argparse.ArgumentParser(description='Convert batch output to import format')
    ...
    if converted > 0:
        ...
        print(f"   Use with: python import_to_db.py {output_file} --db prompts_catalog.db --stats")
