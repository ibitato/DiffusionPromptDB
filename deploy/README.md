...
scp deploy/server_setup.sh root@REDACTED_SERVER_IP:/root/
...
# Debe devolver: REDACTED_SERVER_IP

ping www.diffusionprompt.net
# Debe responder desde REDACTED_SERVER_IP
```
