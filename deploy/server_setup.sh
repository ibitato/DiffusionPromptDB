...
echo "   A Record: www.diffusionprompt.net -> 77.42.30.232"
echo "   A Record: diffusionprompt.net -> 77.42.30.232"
echo ""
...
echo "   http://77.42.30.232 (temporal, hasta que DNS esté configurado)"
